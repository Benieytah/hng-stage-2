        ...
        <Box  borderWidth="1px" borderRadius="lg" overflow="hidden" boxShadow="md">
            ...
            <Box p={4}  >
                <Flex justify="space-between" align="center" >
                    ...
                    {product.isNew && <Badge borderRadius="full" px={2} background="#28A12D" textColor="#FFFFFF">New</Badge>}
                    {product.isTop && <Badge borderRadius="full" px={2} background="#052E70" textColor="#FFFFFF">Top</Badge>}
                    {product.isSoldout && <Badge borderRadius="full" px={2} background="#010A18" textColor="#FFFFFF">Soldout</Badge>}
                ...
                <Box
                 ...
                 as="h4" 
                 lineHeight="tight"
                  isTruncated height="81px" top="218px"
                  left="394px"  width="295px">{product.name}
                </Box>
